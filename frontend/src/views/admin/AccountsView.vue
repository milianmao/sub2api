<template>
  <AppLayout>
              ...
              <div class="relative" ref="accountToolsDropdownRef">
                ...
                >
                  <div class="max-h-[70vh] overflow-y-auto p-2">
                    ...
                    <button class="account-tools-menu-item" @click="openImportChatGPTSession">
                      <span class="account-tools-menu-icon bg-cyan-50 text-cyan-600 dark:bg-cyan-900/30 dark:text-cyan-300">
                        <Icon name="chat" size="sm" />
                      </span>
                      <span class="flex-1 text-left">{{ t('admin.accounts.chatgptSessionImportEntry') }}</span>
                    </button>
    ...
    <AccountActionMenu :show="menu.show" :account="menu.acc" :position="menu.pos" @close="menu.show = false" @test="handleTest" @stats="handleViewStats" @schedule="handleSchedule" @reauth="handleReAuth" @refresh-token="handleRefresh" @copy-access-token="handleCopyAccessToken" @recover-state="handleRecoverState" @reset-quota="handleResetQuota" @set-privacy="handleSetPrivacy" @generate-checkout-link="handleGenerateCheckoutLink" @create-spark-shadow="handleCreateSparkShadow" />
    <SyncFromCrsModal :show="showSync" @close="showSync = false" @synced="reload" />
    <ImportDataModal :show="showImportData" @close="showImportData = false" @imported="handleDataImported" />
    <ImportChatGPTSessionModal :show="showImportChatGPTSession" :groups="groups" :proxies="proxies" @close="showImportChatGPTSession = false" @imported="handleChatGPTSessionImported" />
...
const showImportChatGPTSession = ref(false)
...
const isAnyModalOpen = computed(() => {
  return (
    ...
    showImportChatGPTSession.value ||
...
const handleChatGPTSessionImported = () => { showImportChatGPTSession.value = false; reload() }
...
const handleCopyAccountEmail = async (a: Account) => {
  const email = String(accountDisplayEmail(a)).trim()
  if (!email) return
