export default {
  ...
  keys: {
    ...
    authorizedGroupsSummary: '{count} groups',
    defaultGroupRequired: 'Please select at least one group',
    authorizedGroupsRequired: 'Please select at least one group',
    defaultGroupMustBeAuthorized: 'Please select at least one group',
    selectAuthorizedGroups: 'Select groups',
    defaultGroupHint: 'Select the groups this API key can use.',
    authorizedGroupsHint: 'Requests can route within the selected group set.',
    noGroup: 'No group',
    ...
    groupRequired: 'Please select at least one group',
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
