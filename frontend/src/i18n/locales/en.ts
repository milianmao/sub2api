export default {
  ...
  keys: {
    ...
    authorizedGroupsSummary: '{count} authorized groups',
    defaultGroupRequired: 'Please select a default group',
    authorizedGroupsRequired: 'Please select authorized groups',
    defaultGroupMustBeAuthorized: 'Default group must be included in authorized groups',
    selectAuthorizedGroups: 'Select authorized groups',
    defaultGroupHint: 'The default group is used for normal routing. To authorize multiple groups, select them below.',
    authorizedGroupsHint: 'The default group is automatically included in authorized groups',
    noGroup: 'No group',
    ...
    groupRequired: 'Please select a default group',
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImport: 'Import',
      chatgptSessionImportEntry: 'Import ChatGPT Session',
      ...
      chatgptSessionImportTitle: 'Import ChatGPT Session',
      chatgptSessionImportHint: 'Paste ChatGPT web session JSON or upload multiple JSON files. The backend will convert them into sub2api accounts and always create new OpenAI OAuth accounts.',
      chatgptSessionImportText: 'Session Text',
      chatgptSessionImportFiles: 'Session Files',
      chatgptSessionImportSelectFiles: 'Select one or more JSON files',
      chatgptSessionImportPlaceholder: 'Paste a single object, an array, newline-delimited JSON, or raw session JSON here.',
      chatgptSessionImportEmpty: 'Please paste session text or choose at least one JSON file',
      chatgptSessionImportButton: 'Start Import',
      chatgptSessionImporting: 'Importing...',
      chatgptSessionImportResult: 'Import Result',
      chatgptSessionImportResultSummary: 'Processed {total}, created {created}, failed {failed}',
      chatgptSessionImportErrors: 'Failure Details',
      chatgptSessionImportSuccess: 'Import completed: created {created}, failed {failed}',
      chatgptSessionImportPartial: 'Import completed with partial failures: created {created}, failed {failed}',
      chatgptSessionImportFailed: 'Failed to import ChatGPT Session',
