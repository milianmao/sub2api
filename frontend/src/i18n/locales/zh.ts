export default {
  ...
  keys: {
    ...
    authorizedGroupsSummary: '已授权 {count} 个分组',
    defaultGroupRequired: '请选择默认分组',
    authorizedGroupsRequired: '请选择授权分组',
    defaultGroupMustBeAuthorized: '默认分组必须包含在授权分组中',
    selectAuthorizedGroups: '选择授权分组',
    defaultGroupHint: '默认分组用于常规请求路由, 如需同时授权多个分组请在下方选择',
    authorizedGroupsHint: '默认分组会自动加入授权分组',
    noGroup: '无分组',
    searchGroup: '搜索分组...',
  ...
  admin: {
    ...
    users: {
      ...
      form: {
        ...
        selectRole: '选择角色',
        level: '用户等级',
        levelPlaceholder: '0 表示普通等级',
        levelHint: '用户等级用于匹配分组的最低可见等级。',
        balanceLabel: '余额',
    ...
    groups: {
      ...
      form: {
        ...
        visibleUsers: '指定可见用户',
        visibleUsersPlaceholder: '选择用户',
        visibleUsersHint: '被指定用户可优先看到该分组；仅超级管理员可配置。',
        nameLabel: '分组名称',
    ...
    accounts: {
      ...
      chatgptSessionImportEntry: '导入 ChatGPT Session',
      chatgptSessionImportTitle: '导入 ChatGPT Session',
      chatgptSessionImportHint: '支持粘贴 ChatGPT Web session JSON 或上传多个 JSON 文件，后端会先转换为 sub2api 导入结构，再批量创建 OpenAI OAuth 账号。',
      chatgptSessionImportText: 'Session 文本',
      chatgptSessionImportFiles: 'Session 文件',
      chatgptSessionImportSelectFiles: '选择一个或多个 JSON 文件',
      chatgptSessionImportPlaceholder: '支持单个对象、数组、换行 JSON 或原始 session JSON',
      chatgptSessionImportEmpty: '请粘贴 Session 文本或至少选择一个 JSON 文件',
      chatgptSessionImportButton: '开始导入',
      chatgptSessionImporting: '导入中...',
      chatgptSessionImportResult: '导入结果',
      chatgptSessionImportResultSummary: '共处理 {total} 条，创建 {created} 条，失败 {failed} 条',
      chatgptSessionImportErrors: '失败详情',
      chatgptSessionImportSuccess: '导入完成：创建 {created} 条，失败 {failed} 条',
      chatgptSessionImportPartial: '导入完成，但有部分失败：创建 {created} 条，失败 {failed} 条',
      chatgptSessionImportFailed: '导入 ChatGPT Session 失败',
      syncFromCrsDesc:
