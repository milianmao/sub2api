export default {
  ...
  keys: {
    ...
    defaultGroup: '分组',
    authorizedGroups: '分组',
    authorizedGroupsSummary: '已选择 {count} 个分组',
    defaultGroupRequired: '请至少选择一个分组',
    authorizedGroupsRequired: '请至少选择一个分组',
    defaultGroupMustBeAuthorized: '请至少选择一个分组',
    selectAuthorizedGroups: '选择分组',
    defaultGroupHint: '选择此 API 密钥可使用的分组集合',
    authorizedGroupsHint: '请求会在所选分组集合内按路由策略选择有效分组',
    noGroup: '无分组',
    searchGroup: '搜索分组...',
