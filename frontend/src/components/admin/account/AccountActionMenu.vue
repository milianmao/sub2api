...
const emit = defineEmits(['close', 'test', 'stats', 'schedule', 'reauth', 'refresh-token', 'copy-access-token', 'recover-state', 'reset-quota', 'set-privacy', 'generate-checkout-link', 'create-spark-shadow'])
const { t } = useI18n()
