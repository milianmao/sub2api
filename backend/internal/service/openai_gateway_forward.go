...
// cacheCodexReasoningReplayFromCompleted stores reusable reasoning data after a completed response.
...
// restoreOpenAIConfuseStreamData restores locally obfuscated OpenAI fields before returning them to the client.
