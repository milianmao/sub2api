...
func (h *UserHandler) Create(c *gin.Context) {
	...
	if req.Role != nil && (*req.Role == service.RoleAdmin || *req.Role == service.RoleSuperAdmin) {
...
func (h *UserHandler) Update(c *gin.Context) {
	...
	if req.Role != nil && (*req.Role == service.RoleAdmin || *req.Role == service.RoleSuperAdmin) {
		...
		if target.Role == service.RoleUser || (target.Role == service.RoleAdmin && *req.Role == service.RoleSuperAdmin) {
			if !middleware.EnforceStepUp(c, h.totpService, h.userService, h.settingService) {
				return
			}
		}
