...
func TestGatewayRoutesGrokOnlyAllowsResponsesHTTP(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{http.MethodPost, "/v1/images/generations", "Images API is not supported for this platform"},
		{http.MethodPost, "/v1/images/edits", "Images API is not supported for this platform"},
		{http.MethodPost, "/images/generations", "Images API is not supported for this platform"},
		{http.MethodPost, "/images/edits", "Images API is not supported for this platform"},
