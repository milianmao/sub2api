...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	microsoftEmailRepository := repository.NewMicrosoftEmailRepository(client)
	microsoftGraphHTTPClient := service.NewMicrosoftGraphHTTPClient()
	microsoftEmailService := service.NewMicrosoftEmailService(microsoftEmailRepository, microsoftGraphHTTPClient)
	microsoftEmailHandler := admin.NewMicrosoftEmailHandler(microsoftEmailService)
	cardMailboxRepository := repository.NewCardMailboxRepository(client)
	cardMailboxService := service.ProvideCardMailboxService(cardMailboxRepository)
	cardMailboxHandler := admin.NewCardMailboxHandler(cardMailboxService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, microsoftEmailHandler, cardMailboxHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
