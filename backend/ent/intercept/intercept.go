...
// The CardMailboxCredentialFunc type is an adapter to allow the use of ordinary function as a Querier.
type CardMailboxCredentialFunc func(context.Context, *ent.CardMailboxCredentialQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f CardMailboxCredentialFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.CardMailboxCredentialQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.CardMailboxCredentialQuery", q)
}

// The TraverseCardMailboxCredential type is an adapter to allow the use of ordinary function as Traverser.
type TraverseCardMailboxCredential func(context.Context, *ent.CardMailboxCredentialQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseCardMailboxCredential) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseCardMailboxCredential) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.CardMailboxCredentialQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.CardMailboxCredentialQuery", q)
}
...
// The MicrosoftEmailAccountFunc type is an adapter to allow the use of ordinary function as a Querier.
type MicrosoftEmailAccountFunc func(context.Context, *ent.MicrosoftEmailAccountQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f MicrosoftEmailAccountFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.MicrosoftEmailAccountQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.MicrosoftEmailAccountQuery", q)
}

// The TraverseMicrosoftEmailAccount type is an adapter to allow the use of ordinary function as Traverser.
type TraverseMicrosoftEmailAccount func(context.Context, *ent.MicrosoftEmailAccountQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseMicrosoftEmailAccount) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseMicrosoftEmailAccount) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.MicrosoftEmailAccountQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.MicrosoftEmailAccountQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.CardMailboxCredentialQuery:
		return &query[*ent.CardMailboxCredentialQuery, predicate.CardMailboxCredential, cardmailboxcredential.OrderOption]{typ: ent.TypeCardMailboxCredential, tq: q}, nil
	...
	case *ent.MicrosoftEmailAccountQuery:
		return &query[*ent.MicrosoftEmailAccountQuery, predicate.MicrosoftEmailAccount, microsoftemailaccount.OrderOption]{typ: ent.TypeMicrosoftEmailAccount, tq: q}, nil
