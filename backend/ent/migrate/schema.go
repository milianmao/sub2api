...
var (
	...
	APIKeyGroupsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "apikeygroup_priority",
				Unique:  false,
				Columns: []*schema.Column{APIKeyGroupsColumns[0]},
			},
			{
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "pool_revision", Type: field.TypeInt64, Default: 0},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "access_mode", Type: field.TypeString, Size: 20, Default: "public"},
		{Name: "min_user_level", Type: field.TypeInt, Default: 0},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		...
		{Name: "allow_openai_compat", Type: field.TypeBool, Default: false},
		...
		{Name: "openai_image_upstream", Type: field.TypeString, Size: 50, Default: "auto"},
