...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.BatchImageItem, c.BatchImageJob, c.CardMailboxCredential, c.ChannelMonitor,
		...
		c.MicrosoftEmailAccount, c.PaymentAuditLog, c.PaymentOrder,
...
type (
	hooks struct {
		...
		BatchImageJob, CardMailboxCredential, ChannelMonitor,
