...
func init() {
	...
	// accountDescPoolRevision is the schema descriptor for pool_revision field.
	accountDescPoolRevision := accountFields[12].Descriptor()
	// account.DefaultPoolRevision holds the default value on creation for the pool_revision field.
	account.DefaultPoolRevision = accountDescPoolRevision.Default.(int64)
	// account.PoolRevisionValidator is a validator for the "pool_revision" field. It is called by the builders before save.
	account.PoolRevisionValidator = accountDescPoolRevision.Validators[0].(func(int64) error)
	...
	groupDescAccessMode := groupFields[8].Descriptor()
	...
	groupDescMinUserLevel := groupFields[9].Descriptor()
	...
	groupDescAllowOpenaiCompat := groupFields[42].Descriptor()
	...
	groupDescOpenaiImageUpstream := groupFields[48].Descriptor()
	...
	groupDescProfitControlEnabled := groupFields[53].Descriptor()
	...
	groupDescProfitMinMargin := groupFields[54].Descriptor()
	...
	groupDescProfitSafetyBuffer := groupFields[55].Descriptor()
