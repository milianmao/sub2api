...
func init() {
	...
	groupDescAllowOpenaiCompat := groupFields[49].Descriptor()
	...
	groupDescOpenaiImageUpstream := groupFields[57].Descriptor()
	...
	groupDescCodexModelsManifestConfig := groupFields[59].Descriptor()
