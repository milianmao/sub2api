...
type Group struct {
	...
	// MinUserLevel holds the value of the "min_user_level" field.
	...
	// Whether Anthropic/Antigravity groups allow OpenAI-compatible endpoint conversion
	AllowOpenaiCompat bool `json:"allow_openai_compat,omitempty"`
	...
	// OpenAI image upstream strategy for this group
...
type GroupEdges struct {
	...
	// AuthorizedAPIKeys holds the value of the authorized_api_keys edge.
	AuthorizedAPIKeys []*APIKey `json:"authorized_api_keys,omitempty"`
...
// AuthorizedAPIKeysOrErr returns the AuthorizedAPIKeys value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) AuthorizedAPIKeysOrErr() ([]*APIKey, error) {
	if e.loadedTypes[5] {
		return e.AuthorizedAPIKeys, nil
	}
	return nil, &NotLoadedError{edge: "authorized_api_keys"}
}
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelsListConfig:
			values[i] = new([]byte)
		case group.FieldIsExclusive, group.FieldAllowImageGeneration, group.FieldImageRateIndependent, group.FieldClaudeCodeOnly, group.FieldModelRoutingEnabled, group.FieldMcpXMLInject, group.FieldAllowMessagesDispatch, group.FieldAllowOpenaiCompat, group.FieldRequireOauthOnly, group.FieldRequirePrivacySet:
		...
		case group.FieldID, group.FieldMinUserLevel, group.FieldDefaultValidityDays, group.FieldFallbackGroupID, group.FieldFallbackGroupIDOnInvalidRequest, group.FieldSortOrder, group.FieldRpmLimit:
			values[i] = new(sql.NullInt64)
		case group.FieldName, group.FieldDescription, group.FieldAccessMode, group.FieldStatus, group.FieldPlatform, group.FieldSubscriptionType, group.FieldDefaultMappedModel, group.FieldOpenaiImageUpstream:
	...
	for i := range columns {
		...
		case group.FieldMinUserLevel:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field min_user_level", values[i])
			} else if value.Valid {
				_m.MinUserLevel = int(value.Int64)
			}
		...
		case group.FieldAllowOpenaiCompat:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field allow_openai_compat", values[i])
			} else if value.Valid {
				_m.AllowOpenaiCompat = value.Bool
			}
		...
		case group.FieldOpenaiImageUpstream:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field openai_image_upstream", values[i])
			} else if value.Valid {
				_m.OpenaiImageUpstream = value.String
			}
...
// QueryAuthorizedAPIKeys queries the "authorized_api_keys" edge of the Group entity.
func (_m *Group) QueryAuthorizedAPIKeys() *APIKeyQuery {
	return NewGroupClient(_m.config).QueryAuthorizedAPIKeys(_m)
}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("min_user_level=")
	builder.WriteString(fmt.Sprintf("%v", _m.MinUserLevel))
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("allow_openai_compat=")
	builder.WriteString(fmt.Sprintf("%v", _m.AllowOpenaiCompat))
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("openai_image_upstream=")
	builder.WriteString(_m.OpenaiImageUpstream)
	builder.WriteString(", ")
